...
func Tabs(ariaLabel string, items []TabItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, item := range items {
			var templ_7745c5c3_Var3 = []any{"tab", "btn", "btn-sm", "btn-ghost"}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `models/shared/component_tabs.templ`, Line: 15, Col: 68}
			}
