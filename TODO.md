- check read-only user pages (admin pages looks good)
- notifications
- notify loggen in user when added / removed from group. on remove, redirect him to /dashboard
- remove unecesasry sidebars (e.g. read only users)
