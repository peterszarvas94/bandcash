...
func GroupDetailsContent(data GroupPageData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = shared.DetailsGrid([]shared.DetailsRow{
			...
			{Label: ctxi18n.T(ctx, "groups.unpaid_payouts"), Value: utils.FormatNumberLocalizedWithSign(ctx, data.PayoutsUnpaid, false), ValueClass: "text-muted"},
			{Label: ctxi18n.T(ctx, "groups.paid_payouts"), Value: utils.FormatNumberLocalizedWithSign(ctx, data.PayoutsPaid, false)},
			{Label: ctxi18n.T(ctx, "groups.unpaid_expenses"), Value: utils.FormatNumberLocalizedWithSign(ctx, data.ExpensesUnpaid, false), ValueClass: "text-muted"},
			{Label: ctxi18n.T(ctx, "groups.paid_expenses"), Value: utils.FormatNumberLocalizedWithSign(ctx, data.ExpensesPaid, false)},
...
func GroupSidebar(data GroupPageData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `models/group/page_show.templ`, Line: 92, Col: 81}
		}
		...
		if data.IsAdmin {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `models/group/page_show.templ`, Line: 95, Col: 50}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `models/group/page_show.templ`, Line: 97, Col: 78}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `models/group/page_show.templ`, Line: 98, Col: 127}
			}
