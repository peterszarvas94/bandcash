...
func GroupSidebar(groupID string, activeTab string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = Sidebar(ctxi18n.T(ctx, "groups.actions"), []SidebarItem{
			...
			{Label: ctxi18n.T(ctx, "groups.pending_incomes"), Href: "/groups/" + groupID + "/pending-incomes", IsActive: activeTab == "pending_incomes", IconName: icons.IconBanknoteArrowUp},
			{Label: ctxi18n.T(ctx, "groups.pending_payouts"), Href: "/groups/" + groupID + "/pending-payouts", IsActive: activeTab == "pending_payouts", IconName: icons.IconBanknoteArrowDown},
			{Label: ctxi18n.T(ctx, "groups.recent_incomes"), Href: "/groups/" + groupID + "/recent-incomes", IsActive: activeTab == "recent_incomes", IconName: icons.IconClockArrowUp},
			{Label: ctxi18n.T(ctx, "groups.recent_payouts"), Href: "/groups/" + groupID + "/recent-payouts", IsActive: activeTab == "recent_payouts", IconName: icons.IconClockArrowDown},
