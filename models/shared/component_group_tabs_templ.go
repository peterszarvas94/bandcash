...
func GroupSidebar(groupID string, activeTab string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = Sidebar(ctxi18n.T(ctx, "groups.actions"), []SidebarItem{
			...
			{Label: ctxi18n.T(ctx, "groups.to_receive"), Href: "/groups/" + groupID + "/to-receive", IsActive: activeTab == "to_receive", IconName: icons.IconBanknoteArrowUp},
			{Label: ctxi18n.T(ctx, "groups.to_pay"), Href: "/groups/" + groupID + "/to-pay", IsActive: activeTab == "to_pay", IconName: icons.IconBanknoteArrowDown},
			{Label: ctxi18n.T(ctx, "groups.recent_income"), Href: "/groups/" + groupID + "/recent-income", IsActive: activeTab == "recent_income", IconName: icons.IconClockArrowUp},
			{Label: ctxi18n.T(ctx, "groups.recent_outgoing"), Href: "/groups/" + groupID + "/recent-outgoing", IsActive: activeTab == "recent_outgoing", IconName: icons.IconClockArrowDown},
