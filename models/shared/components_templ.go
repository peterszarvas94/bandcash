...
func Notifications() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "</ul></div><div id=\"sure-popover\" class=\"sure-popover\" data-signals=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(templ.JSONString(map[string]any{
			"sureOpen":        false,
			"sureTitle":       ctxi18n.T(ctx, "actions.confirm"),
			"sureMessage":     "",
			"sureSubmitLabel": ctxi18n.T(ctx, "actions.confirm"),
			"sureCancelLabel": ctxi18n.T(ctx, "actions.cancel"),
			"sureMethod":      "post",
			"sureURL":         "",
			"sureTriggerID":   "",
			"sureFetching":    false,
