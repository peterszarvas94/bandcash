...
func RegisterRoutes(e *echo.Echo) *Group {
	...
	usersRoutes.GET("/to-pay", grp.ToPayPage)
	usersRoutes.GET("/to-receive", grp.ToReceivePage)
	usersRoutes.GET("/recent-income", grp.RecentIncomePage)
	usersRoutes.GET("/recent-outgoing", grp.RecentOutgoingPage)
